...
unsigned char* editImage(unsigned char* input) {
	...
	case 0:
		...
		imageEditor->fillRect(0, 0, 60, 70);
		imageEditor->addLayer();
		imageEditor->setActiveColor("#FF0000");
		imageEditor->fillRect(0, 0, 50, 50);
		imageEditor->addLayer();
		imageEditor->setActiveColor("#FFFF00");
		imageEditor->fillRect(100, 100, 50, 50); // prekoracuje dimanzije slike
		...
		imageEditor->setActiveColor("#FF0000");
		imageEditor->fillRect(0, 0, 50, 50);
		imageEditor->eraseRect(25, 25, 25, 25);
		imageEditor->setActiveColor("#FFFF00");
		imageEditor->fillRect(50, 50, 25, 25);
		output = imageEditor->saveImage();*/
		...
		imageEditor->fillRect(0, 0, 60, 70);
		imageEditor->addLayer();
		imageEditor->setLayerOpacity(25);
		imageEditor->setActiveColor("#FF0000");
		imageEditor->fillRect(0,0,50,50);
		imageEditor->selectLayer(1);
		imageEditor->deleteLayer();
